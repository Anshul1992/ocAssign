Examples to demonstrate working on spark+python

1. SQL: 

A company conducts events in a stadium, each event many people visit it and the stats are saved as these columns: id, event_name, people_count
